...
class ProfileEditScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final newProfile = Get.arguments;
                      ...
                      : Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                navigationController.controller.setupProfile(navigationController.isUser.value, profilePic: navigationController.controller.profilePicture.value, isEdit: false, newProfile: newProfile);
...
// List of pronouns
final List<String> pronouns = ['She/Her', 'He/Him', 'They/Them', 'Custom'];
